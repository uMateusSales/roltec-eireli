  ...
  return (
    <li className="flex py-6 border-b">
      ...
      <div className="relative ml-4 flex flex-1 flex-col justify-between sm:ml-6">
        ...
        <div className="relative pr-7 md:grid md:grid-cols-2 md:gap-x-6 ">
          ...
          <div className="mt-1 flex text-sm items-center  ">
            ...
            <div className="flex justify-between items-center gap-2 ml-2  border-l border-gray-200">
              <IconButton onClick={removeFromCart} icon={<Minus size={15} />} />
              <p className="text-gray-500 ">{itemsInCart}</p>
              <IconButton onClick={addToCart} icon={<Plus size={15} />} />
            </div>
          </div>
